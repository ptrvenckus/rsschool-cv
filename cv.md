...
```
int main()
{ // this c++ code I implemented inside of one long conspect to switch quickly between different topics
unsigned char chosenMethod; cout << endl;
cout << "Please write a character, assigned to the method you want to run.\n";
cout default: cout << "Something is going wrong..." << endl;
}
return 0;
} endl;
cout << "Available methods:\n'a': greeting(); 'A': variables(); 'b': salary(); 'B': sizes() // plus other methods" << endl;
cin >> chosenMethod;
switch(chosenMethod) {
case 'a': greeting(); break;
